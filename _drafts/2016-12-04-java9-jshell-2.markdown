...
Nothing surprising, but that's not all I can do. I can also modify history. When I enter `/edit`, beautifully ugly windows pops up

![jshell]({{ site.url }}/assets/jshell/jshellEditPad.png) 
